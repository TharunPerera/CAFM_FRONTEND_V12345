...
//     name: "",
//     serviceScopeId: "",
//     content: [], // Store as array of strings
//   });
...
//   useEffect(() => {
//     if (checklist) {
//       // Parse content, converting from object array to string array if necessary
//       let contentArray = [];
...
//       setFormData((prev) => ({
//         ...prev,
//         content: [...prev.content, newTask.trim()],
//       }));
//       setNewTask("");
//       if (errors.content) {
...
//     setFormData((prev) => ({
//       ...prev,
//       content: prev.content.map((task, i) => (i === index ? value : task)),
//     }));
//   };
...
//     if (formData.content.length === 0)
//       newErrors.content = "At least one task is required";
//     if (formData.content.some((task) => !task.trim())) {
//       newErrors.content = "All tasks must have content";
//     }
//     setErrors(newErrors);
//     return Object.keys(newErrors).length === 0;
...
//         name: formData.name,
//         serviceScopeId: formData.serviceScopeId,
//         content: JSON.stringify(formData.content), // Send as array of strings
//       };
...
//             </div>
//             <div className="space-y-3">
//               {formData.content.map((task, index) => (
//                 <div key={index} className="flex gap-3 items-center">
//                   <div className="flex-shrink-0 w-8 h-8 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-sm font-medium">
//                     {index + 1}
//                   </div>
...
//         name: formData.name,
//         serviceScopeId: formData.serviceScopeId,
//         tasks: formData.tasks, // Send as array of objects
//       };
