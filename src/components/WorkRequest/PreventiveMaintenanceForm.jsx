...
//                   <input
//                     type="checkbox"
//                     checked={formData.assetIds.includes(asset.assetId)}
...
//               {formData.assetIds.length} asset(s) selected
//             </p>
//           )}
//         </div>
...
// const PreventiveMaintenanceForm = ({ onBack }) => {
//   const [formData, setFormData] = useState({
//     assetSchedules: [], // Changed from assetIds to assetSchedules
//     frequency: "DAYS_30",
//     contractId: "",
//     reasonComment: "",
//     startDate: "",
...
//     try {
//       const response = await assetService.getAssetServiceScopes(assetId);
//       setServiceScopes((prev) => ({ ...prev, [assetId]: response.data || [] }));
//     } catch (error) {
//       console.error(
...
//     }));
//     if (serviceScopeId) {
//       loadChecklists(assetId, serviceScopeId); // Load checklists when service scope is selected
//     } else {
