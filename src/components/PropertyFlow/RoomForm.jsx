...
//       loadFloorsForContract(formData.contractId);
//     }
//   }, [formData.contractId]);
...
//   const loadFloorsForContract = async (contractId) => {
//     try {
...
//     setLoading(true);
//     try {
//       // Implementation for loading existing room data
//     } catch (error) {
...
//     try {
//       if (isEdit) {
//         await propertyFlowService.updateRoom(roomId, formData, imageFile);
//       } else {
//         await propertyFlowService.createRoom(formData, imageFile);
//       }
...
//                   onChange={handleInputChange}
//                   placeholder="Enter room name (e.g., Living Room, Bedroom 1, Kitchen)"
//                   required
//                   className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
//                 />
//               </div>
...
const RoomForm = ({ isEdit = false }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      alert(
        "Please fill in all required fields (name, contract, floor, and location)"
      );
      return;
    }
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label
                  ...
                  className="block text-sm font-medium text-gray-700"
                >
                  Room Image <span className="text-gray-500">(Optional)</span>
                </label>
                <div className="flex items-center gap-4">
                  <input
                    type="file"
                ...
                <p className="text-xs text-gray-500">
                  You can add an image now or later when editing the room
                </p>
              </div>
            </div>
          </div>
