...
//       loadSubZonesForContract(formData.contractId);
//     }
//   }, [formData.contractId]);
...
//   const loadSubZonesForContract = async (contractId) => {
//     try {
//       const response = await propertyFlowService.getAllSubZonesByContract(
//         contractId
//       );
//       setAvailableSubZones(response.data);
//     } catch (error) {
...
//     setLoading(true);
//     try {
//       // Implementation for loading existing building data
//     } catch (error) {
...
//     try {
//       if (isEdit) {
//         await propertyFlowService.updateBuilding(
//           buildingId,
//           formData,
//           imageFile
//         );
//       } else {
//         await propertyFlowService.createBuilding(formData, imageFile);
//       }
...
const BuildingForm = ({ isEdit = false }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      alert(
        "Please fill in all required fields (name, contract, subzone, and location)"
      );
      return;
    }
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  You can add an image now or later when editing the building
                </p>
              </div>
            </div>
          </div>
