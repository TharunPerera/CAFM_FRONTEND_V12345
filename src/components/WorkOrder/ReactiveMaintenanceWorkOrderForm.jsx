...
//       // Filter for approved RM work requests
//       const rmWorkRequests = (response.data || []).filter(
//         (wr) => wr.workRequestType === "RM" && wr.status === "APPROVED"
//       );
//       setWorkRequests(rmWorkRequests);
//     } catch (error) {
...
//           Create a work order for approved reactive maintenance work requests
//         </p>
//       </div>
...
//               No approved RM work requests available
//             </p>
//           )}
//         </div>
