...
//   ClipboardList,
//   CheckCircle,
//   Clock, // Replaced Calendar for Technician Availability
//   Calendar,
//   ChevronLeft,
//   ChevronRight,
//   Wrench,
//   Key, // New icon for Permission Management
// } from "lucide-react";
...
//     {
//       path: "/work-orders",
//       icon: FileText, // Already unique, kept as is
//       label: "Work Orders",
//       permission: "view_work_order",
//     },
//     {
...
//     {
//       path: "/technician-availability",
//       icon: Clock, // Changed from Calendar to Clock
//       label: "Technician Availability",
//       permission: "view_technician_availability",
//     },
//     {
...
//     {
//       path: "/permissionManagement",
//       icon: Key, // Changed from Wrench to Key
//       label: "Permission Management",
//       permission: "view_permission",
//     },
//   ].filter(
...
//                                     px-3 py-2 bg-gray-900/95 text-white text-sm rounded-xl
//                                     shadow-xl opacity-0 scale-90 invisible
//                                     group-hover:opacity-100 group-hover:scale-100 group-hover:visible
//                                     transition-all duration-200 ease-in-out whitespace-nowrap z-50 hidden md:block"
//                     >
//                       {item.label}
//                       {/* Tooltip arrow */}
//                       <div
//                         className="absolute top-1/2 left-0 transform -translate-y-1/2 -translate-x-2
