...
//       [name]: value
//         ? ""
//         : `${name === "name" ? "Scope name" : "Sub-service"} is required.`,
//     };
//     setErrors(newErrors);
//     setApiError(null);
//   };
...
//       name: sc.name ? "" : "Scope name is required.",
//       subServiceId: sc.subServiceId ? "" : "Sub-service is required.",
//     }));
//     setErrors(newErrors);
//     if (newErrors.some((e) => e.name || e.subServiceId)) {
//       return;
//     }
//     try {
...
//       setServiceScopes([{ name: "", description: "", subServiceId: "" }]);
//       setErrors([{}]);
//       setTimeout(() => {
