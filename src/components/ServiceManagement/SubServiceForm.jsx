...
// const SubServiceForm = ({ onSubmit, initialData = {}, isEdit = false }) => {
//   const [formData, setFormData] = useState({
//     subServiceName: initialData.subServiceName || "",
...
//       if (!isEdit) {
//         setFormData({ subServiceName: "", description: "", serviceId: "" });
//       }
//       setErrors({});
//     } catch (error) {
//       setApiError(
//         error.response?.data?.message ||
//           "Failed to save sub-service. Please try again."
//       );
//     }
//   };
...
//             <InformationCircleIcon
//               className="ml-2 h-4 w-4 text-gray-400 cursor-help"
//               title="Optional: Provide a description of the sub-service"
//             />
//           </label>
//           <textarea
//             name="description"
