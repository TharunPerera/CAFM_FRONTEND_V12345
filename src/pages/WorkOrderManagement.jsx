...
//     if (type && workOrderTypes.find((t) => t.id === type)) {
//       setActiveView(type);
//     }
//   }, [location.search]);
...
//       const ComponentToRender = selectedType.component;
//       const params = new URLSearchParams(location.search);
//       const workRequestId = params.get("workRequestId");
//       return (
//         <ComponentToRender
//           onBack={() => setActiveView("main")}
//           initialWorkRequestId={workRequestId}
//         />
//       );
//     }
...
const WorkOrderManagement = () => {
  ...
  return (
    ...
    >
      ...
      >
        {workOrderTypes.some((type) => type.id === activeView) && (
          <div className="mb-6">
            <button
              onClick={() => setActiveView("main")}
              className="inline-flex items-center px-4 py-2 bg-white rounded-lg shadow-md hover:shadow-lg transition-all border border-gray-200"
