...
//   const [sortBy, setSortBy] = useState("all"); // 'all' or 'least-assigned'
...
//         // For least assigned, we get a simple array, so we need to format it for pagination
...
//         await technicianService.setAvailable(technicianId);
//         toast.success("Technician set as available");
//       } else if (newStatus === "NOT_AVAILABLE") {
//         await technicianService.setNotAvailable(technicianId);
//         toast.success("Technician set as not available");
//       }
...
//   // Filter technicians based on search term (client-side filtering for least-assigned)
...
//   // For least-assigned view, we need to paginate client-side
...
//             </h1>
//             <p className="text-gray-600">
//               Manage technician availability status and assignments
//             </p>
//           </div>
//         </div>
...
//                             onClick={() =>
//                               handleStatusChange(
//                                 technician.internalUserId,
//                                 "AVAILABLE"
//                               )
//                             }
//                             disabled={
//                               updatingId === technician.internalUserId ||
//                               technician.availabilityStatus === "AVAILABLE"
//                             }
//                             className="p-2 text-green-600 hover:text-green-900 hover:bg-green-100 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
//                             title="Set Available"
//                           >
//                             {updatingId === technician.internalUserId ? (
...
//                             }
//                             className="p-2 text-red-600 hover:text-red-900 hover:bg-red-100 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
...
//       if (sortBy === "least-assigned") {
//         response = await technicianService.getTechniciansByLeastAssigned();
//         console.log("Least Assigned Response:", response.data); // Log for debugging
//         const data = response.data || [];
//         setTechnicians(data);
//         setTotalElements(data.length);
//         setTotalPages(Math.ceil(data.length / pageSize));
...
//           statusFilter || null
//         );
//         console.log("All Technicians Response:", response.data); // Log for debugging
//         const pageData = response.data;
//         setTechnicians(pageData.content || []);
//         setTotalElements(pageData.totalElements || 0);
//         setTotalPages(pageData.totalPages || 0);
...
//                   paginatedTechnicians.map((technician, index) => (
//                     <tr
//                       key={technician.userId} // Changed from internalUserId to userId
//                       className={`hover:bg-gray-50 ${
//                         index % 2 === 0 ? "bg-white" : "bg-gray-50"
//                       }`}
//                     >
...
//                                   technician.userId,
//                                   "AVAILABLE"
//                                 ) // Changed from internalUserId to userId
//                             }
//                             disabled={
//                               updatingId === technician.userId ||
//                               technician.availabilityStatus === "AVAILABLE"
//                             }
//                             className="p-2 text-green-600 hover:text-green-900 hover:bg-green-100 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
//                             title="Set Available"
...
//     } catch (error) {
//       console.error(
//         `Error updating technician status for technicianId ${technicianId}:`,
//         {
...
//                   paginatedTechnicians.map((technician, index) => (
//                     <tr
//                       key={technician.technicianId} // Use technicianId as unique key
//                       className={`hover:bg-gray-50 ${
//                         index % 2 === 0 ? "bg-white" : "bg-gray-50"
//                       }`}
//                     >
...
//                             }
//                             disabled={
//                               updatingId === technician.technicianId ||
//                               technician.availabilityStatus === "AVAILABLE"
//                             }
//                             className="p-2 text-green-600 hover:text-green-900 hover:bg-green-100 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
//                             title="Set Available"
...
//                               technician.availabilityStatus === "AVAILABLE"
//                             }
//                             className="px-3 py-1 text-sm text-green-600 hover:text-green-900 hover:bg-green-100 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
//                             title="Set Available"
//                           >
//                             {updatingId === technician.technicianId ? (
...
//                               technician.availabilityStatus === "NOT_AVAILABLE"
//                             }
//                             className="px-3 py-1 text-sm text-red-600 hover:text-red-900 hover:bg-red-100 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
//                             title="Set Not Available"
//                           >
//                             {updatingId === technician.technicianId ? (
...
//       // Open modal for NOT_AVAILABLE status to get reason
...
//   // Truncation function for reason text
...
//         response = await technicianService.getTechniciansByLeastAssigned();
//         const data = response.data || [];
//         console.log("Least Assigned Technicians:", data); // Debug log
//         setTechnicians(data);
//         setTotalElements(data.length);
//         setTotalPages(Math.ceil(data.length / pageSize));
//       } else {
...
//         );
//         const pageData = response.data;
//         console.log("All Technicians:", pageData.content); // Debug log
//         setTechnicians(pageData.content || []);
//         setTotalElements(pageData.totalElements || 0);
//         setTotalPages(pageData.totalPages || 0);
//       }
...
//   const handleOpenAvailabilityModal = (technician) => {
//     console.log("Opening modal for technician:", technician); // Debug log
//     setSelectedTechnician(technician);
//     setAvailabilityStatus(technician.availabilityStatus || "AVAILABLE");
//     setNotAvailableReason(technician.notAvailableReason || "");
//     setShowAvailabilityModal(true);
...
//           .filter((s) => s.length > 0);
//         if (skills.length > 0) {
//           response = await technicianService.getTechniciansBySkills(
//             skills,
//             statusFilter || null,
//             currentPage,
//             pageSize
...
//               <input
//                 type="text"
//                 placeholder="Search by skill(s), comma separated..."
//                 value={skillFilter}
//                 onChange={(e) => handleFilterChange("skill", e.target.value)}
//                 className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
//               />
