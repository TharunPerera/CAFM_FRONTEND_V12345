...
//     setTimeout(() => {
//       if (qrCodeRef.current) {
//         // Create the URL for direct navigation to this asset
//         const baseUrl = window.location.origin;
//         const assetUrl = `${baseUrl}/assets/detail/${asset.assetId}`;

//         const qrData = JSON.stringify({
//           url: assetUrl, // Add URL for direct navigation
//           assetId: asset.assetId,
//           assetTag: asset.assetTag,
//           assetName: asset.assetName,
//           serialNumber: asset.serialNumber || "",
...
//             purchaseDate: asset.purchaseDate || "",
//             installationDate: asset.installationDate || "",
//             assetAgeDays: asset.assetAgeDays || 0,
//             warrantyPeriodDays: asset.warrantyPeriodDays || 0,
//             remainingWarrantyPeriodDays: asset.remainingWarrantyPeriodDays || 0,
//             warrantyExpiryDate: asset.warrantyExpiryDate || "",
//             expectedUsefulLifeDays: asset.expectedUsefulLifeDays || 0,
//             lastAuditDate: asset.lastAuditDate || "",
//           },
//           companyName: asset.companyName,
//           contractName: asset.contractName,
...
//           {/* Asset Age and Warranty Information */}
...
//                 <Clock className="w-4 h-4 mr-2 text-gray-500" />
//                 <div>
//                   <p className="text-sm text-gray-500">Asset Age</p>
//                   <p className="font-medium">
...
//                 <Shield className="w-4 h-4 mr-2 text-gray-500" />
//                 <div>
//                   <p className="text-sm text-gray-500">Remaining Warranty</p>
//                   <p className="font-medium">
...
//                 <Calendar className="w-4 h-4 mr-2 text-gray-500" />
//                 <div>
//                   <p className="text-sm text-gray-500">Warranty Expiry Date</p>
//                   <p className="font-medium">
...
//               <canvas ref={qrCodeRef} className="mx-auto mb-4"></canvas>
//               <p className="text-sm text-gray-600 mb-4">
//                 Scan this QR code to access asset information. When scanned, it
//                 will navigate directly to this asset's detail page.
//               </p>
...
// import { useState, useEffect, useRef } from "react";
// import { useParams, Link, useNavigate } from "react-router-dom";
// import { ArrowLeft, Edit, Trash2, Calendar, Tag, Barcode, Box, Cpu, Info, Building, MapPin, Layers, Home, DoorOpen, Wrench, User, Clock, QrCode, Download, Printer, ImageIcon, ChevronLeft, ChevronRight, AlertCircle, Shield } from "lucide-react";
// import { assetService } from "../services/assetService";
// import { toast } from "react-toastify";
// import QRCode from "qrcode";
...
//   const prevImage = () => {
//     if (asset?.imageUrls?.length > 0) {
//       setCurrentImageIndex((prev) => (prev === 0 ? asset.imageUrls.length - 1 : prev - 1));
//     }
//   };
...
//     setShowQRModal(true);
//     setTimeout(() => {
//       if (qrCodeRef.current && asset) {
//         const baseUrl = window.location.origin;
//         const assetUrl = `${baseUrl}/assets/detail/${asset.assetId}`;
//         // Simplify QR code data to include essential fields only
//         const qrData = JSON.stringify({
//           url: assetUrl, // Primary navigation URL
//           assetId: asset.assetId,
//           assetTag: asset.assetTag,
//           assetName: asset.assetName,
//           serialNumber: asset.serialNumber || "",
//           serviceName: asset.serviceName || "",
//           subServiceName: asset.subServiceName || "",
//           serviceScopeNames: asset.serviceScopeNames || [], // Include multiple service scopes
//           location: `${asset.zoneName}, ${asset.subZoneName}, ${asset.buildingName}, ${asset.villaApartmentName}, ${asset.floorName}, ${asset.roomName}`,
//         });
...
//     if (qrCodeRef.current) {
//       const link = document.createElement("a");
//       link.download = `asset-${asset?.assetTag || "unknown"}-qrcode.png`;
//       link.href = qrCodeRef.current.toDataURL("image/png");
//       link.click();
//     }
//   };
...
//               <h2>Asset QR Code</h2>
//               <img src="${qrCodeImage}" alt="Asset QR Code" />
//               <div class="asset-tag">Asset Tag: ${asset?.assetTag || "unknown"}</div>
//             </div>
//             <script>
//               window.onload = function() { window.print(); }
//             </script>
...
//       <div className="text-center py-12">
//         <p className="text-xl text-gray-600">Asset not found</p>
//         <Link to="/assets/list" className="mt-4 inline-flex items-center text-blue-600 hover:underline">
//           <ArrowLeft className="w-4 h-4 mr-2" />
//           Back to Asset List
//         </Link>
//       </div>
...
//       <div className="flex justify-between items-center">
//         <div className="flex items-center">
//           <Link to="/assets/list" className="mr-4 p-2 bg-gray-100 rounded-full hover:bg-gray-200">
//             <ArrowLeft className="w-5 h-5 text-gray-600" />
//           </Link>
//           <div>
//             <h1 className="text-2xl font-bold text-gray-900">Asset Details</h1>
...
//                 <div className="relative">
//                   <img
//                     src={asset.imageUrls[currentImageIndex] || "/placeholder.svg"}
//                     alt={`Asset ${currentImageIndex + 1}`}
//                     className="w-full h-64 object-cover rounded-lg border"
//                   />
//                   {asset.imageUrls.length > 1 && (
...
//                 <div>
//                   <p className="text-sm text-gray-500">Asset Age</p>
//                   <p className="font-medium">{asset.assetAgeDays ? `${asset.assetAgeDays} days` : "-"}</p>
//                 </div>
//               </div>
//               <div className="flex items-center">
//                 <Shield className="w-4 h-4 mr-2 text-gray-500" />
//                 <div>
//                   <p className="text-sm text-gray-500">Warranty Period</p>
//                   <p className="font-medium">{asset.warrantyPeriodDays ? `${asset.warrantyPeriodDays} days` : "-"}</p>
//                 </div>
//               </div>
//               <div className="flex items-center">
//                 <Shield className="w-4 h-4 mr-2 text-gray-500" />
...
//                   <p className="text-sm text-gray-500">Remaining Warranty</p>
//                   <p className="font-medium">
//                     {asset.remainingWarrantyPeriodDays !== null ? `${asset.remainingWarrantyPeriodDays} days` : "-"}
//                   </p>
//                 </div>
//               </div>
//               <div className="flex items-center">
...
//                 <div>
//                   <p className="text-sm text-gray-500">Warranty Expiry Date</p>
//                   <p className="font-medium">{asset.warrantyExpiryDate || "-"}</p>
//                 </div>
//               </div>
//               {asset.remainingWarrantyPeriodDays !== null && asset.remainingWarrantyPeriodDays <= 30 && (
//                 <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 mt-2">
//                   <div className="flex">
//                     <AlertCircle className="h-5 w-5 text-yellow-400" />
//                     <div className="ml-3">
...
//                 <Wrench className="w-4 h-4 mr-2 text-gray-500" />
//                 <div>
//                   <p className="text-sm text-gray-500">Contract-Defined Service Scopes</p>
//                   <div className="font-medium">
//                     {asset.serviceScopeNames && asset.serviceScopeNames.length > 0 ? (
//                       <ul className="list-disc pl-5">
//                         {asset.serviceScopeNames.map((scopeName, index) => (
//                           <li key={index}>{scopeName}</li>
//                         ))}
//                       </ul>
//                     ) : (
//                       <p>-</p>
...
//                   <Clock className="w-4 h-4 mr-2 text-gray-500" />
//                   <div>
//                     <p className="text-sm text-gray-500">Expected Useful Life</p>
//                     <p className="font-medium">
//                       {asset.expectedUsefulLifeDays ? `${asset.expectedUsefulLifeDays} days` : "-"}
//                     </p>
//                   </div>
//                 </div>
//                 <div className="flex items-center">
...
//                   <div>
//                     <p className="text-sm text-gray-500">Created By</p>
//                     <p className="font-medium">{asset.createdByUsername || "-"}</p>
//                   </div>
//                 </div>
//                 <div className="flex items-center">
//                   <Calendar className="w-4 h-4 mr-2 text-gray-500" />
//                   <div>
//                     <p className="text-sm text-gray-500">Created At</p>
//                     <p className="font-medium">{asset.createdAt ? new Date(asset.createdAt).toLocaleString() : "-"}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
...
//               <canvas ref={qrCodeRef} className="mx-auto mb-4"></canvas>
//               <p className="text-sm text-gray-600 mb-4">
//                 Scan this QR code to access asset information. When scanned, it will navigate directly to this asset's detail page.
//               </p>
//               <div className="flex gap-3 justify-center">
//                 <button
//                   onClick={downloadQRCode}
...
//             serviceName: asset.serviceName,
//             subServiceName: asset.subServiceName,
//             serviceScopeNames: asset.serviceScopeNames || [],
//           },
//           lifecycle: {
//             purchaseDate: asset.purchaseDate || "",
//             installationDate: asset.installationDate || "",
...
//                 <Wrench className="w-4 h-4 mr-2 text-gray-500 mt-1" />
//                 <div>
//                   <p className="text-sm text-gray-500">
...
//             onClick={generateQRCode}
//             className="inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors"
//             aria-label="Generate QR code for asset"
//           >
...
//                 />
//                 <div>
//                   <p className="text-sm text-gray-500" id="purchaseCost-label">
//                     Purchase Cost
//                   </p>
//                   <p
//                     className="font-medium"
//                     aria-describedby="purchaseCost-label"
//                   >
//                     {formatCurrency(asset.purchaseCost)}
//                   </p>
//                   <p className="text-sm text-gray-500">
//                     Initial cost of the asset in USD
//                   </p>
//                 </div>
//               </div>
...
//                   <p
//                     className="font-medium"
//                     aria-describedby="depreciationType-label"
//                   >
//                     {asset.depreciationType
//                       ? asset.depreciationType.replace("_", " ").toLowerCase()
//                       : "-"}
//                   </p>
//                   <p className="text-sm text-gray-500">
//                     How the asset's value decreases over time
//                   </p>
//                 </div>
//               </div>
...
//                   <p
//                     className="font-medium"
//                     aria-describedby="depreciationValue-label"
//                   >
...
//                       : "Fixed amount deducted per year in USD"}
//                   </p>
//                 </div>
//               </div>
...
//                   <p
//                     className="text-sm text-gray-500"
//                     id="timeFrameYears-label"
//                   >
//                     Depreciation Time Frame
//                   </p>
//                   <p
//                     className="font-medium"
//                     aria-describedby="timeFrameYears-label"
//                   >
//                     {asset.timeFrameYears
...
//                   </p>
//                   <p className="text-sm text-gray-500">
//                     Number of years over which depreciation is calculated
//                   </p>
//                 </div>
//               </div>
...
//                   <p
//                     className="text-sm text-gray-500"
//                     id="currentDepreciatedValue-label"
//                   >
//                     Current Depreciated Value
//                   </p>
//                   <p
//                     className="font-medium text-green-600"
//                     aria-describedby="currentDepreciatedValue-label"
//                   >
...
//                 />
//                 <div>
//                   <p className="text-sm text-gray-500" id="assetAgeDays-label">
//                     Asset Age
//                   </p>
//                   <p
//                     className="font-medium"
//                     aria-describedby="assetAgeDays-label"
//                   >
//                     {asset.assetAgeDays ? `${asset.assetAgeDays} days` : "-"}
//                   </p>
//                 </div>
...
//                   <p
//                     className="text-sm text-gray-500"
//                     id="warrantyPeriodDays-label"
//                   >
//                     Warranty Period
//                   </p>
//                   <p
//                     className="font-medium"
//                     aria-describedby="warrantyPeriodDays-label"
//                   >
//                     {asset.warrantyPeriodDays
//                       ? `${asset.warrantyPeriodDays} days`
//                       : "-"}
...
//                   <p
//                     className="text-sm text-gray-500"
//                     id="remainingWarrantyPeriodDays-label"
//                   >
//                     Remaining Warranty
//                   </p>
//                   <p
//                     className="font-medium"
//                     aria-describedby="remainingWarrantyPeriodDays-label"
//                   >
//                     {asset.remainingWarrantyPeriodDays !== null
//                       ? `${asset.remainingWarrantyPeriodDays} days`
//                       : "-"}
...
//                   <p
//                     className="text-sm text-gray-500"
//                     id="warrantyExpiryDate-label"
//                   >
//                     Warranty Expiry Date
//                   </p>
//                   <p
//                     className="font-medium"
//                     aria-describedby="warrantyExpiryDate-label"
//                   >
//                     {asset.warrantyExpiryDate || "-"}
//                   </p>
//                 </div>
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="assetTag-label">
//                       Asset Tag
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="assetTag-label"
//                     >
//                       {asset.assetTag}
//                     </p>
//                   </div>
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="assetName-label">
//                       Asset Name
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="assetName-label"
//                     >
//                       {asset.assetName}
//                     </p>
//                   </div>
...
//                     <p
//                       className="font-medium"
//                       aria-describedby="serialNumber-label"
//                     >
//                       {asset.serialNumber || "-"}
//                     </p>
//                   </div>
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="ownerType-label">
//                       Owner Type
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="ownerType-label"
//                     >
//                       {asset.ownerType}
//                     </p>
//                   </div>
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="brandName-label">
//                       Brand Name
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="brandName-label"
//                     >
//                       {asset.brandName || "-"}
//                     </p>
//                   </div>
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="modelNumber-label">
//                       Model Number
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="modelNumber-label"
//                     >
//                       {asset.modelNumber || "-"}
//                     </p>
//                   </div>
...
//                   </div>
//                   <div>
//                     <p className="text-sm text-gray-500" id="assetStatus-label">
//                       Status
//                     </p>
//                     <span
//                       className={`px-2 py-1 text-xs font-semibold rounded-full ${
...
//                           : "bg-red-100 text-red-800"
//                       }`}
//                       aria-describedby="assetStatus-label"
//                     >
//                       {asset.assetStatus.replace("_", " ")}
//                     </span>
//                   </div>
...
//                           : "bg-red-100 text-red-800"
//                       }`}
//                       aria-describedby="assetCondition-label"
//                     >
...
//                   <div className="flex items-start">
//                     <FileText
//                       className="w-4 h-4 mr-2 text-gray-500 mt-1"
//                       aria-hidden="true"
//                     />
//                     <div>
//                       <p
...
//                       <p
//                         className="font-medium"
//                         aria-describedby="observation-label"
//                       >
//                         {asset.observation}
//                       </p>
//                     </div>
...
//                       <p
//                         className="font-medium"
//                         aria-describedby="recommendation-label"
//                       >
//                         {asset.recommendation}
//                       </p>
//                     </div>
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="zoneName-label">
//                       Zone
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="zoneName-label"
//                     >
//                       {asset.zoneName}
//                     </p>
//                   </div>
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="subZoneName-label">
//                       Sub Zone
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="subZoneName-label"
//                     >
//                       {asset.subZoneName}
//                     </p>
//                   </div>
...
//                     <p
//                       className="font-medium"
//                       aria-describedby="buildingName-label"
//                     >
//                       {asset.buildingName}
//                     </p>
//                   </div>
...
//                     <p
//                       className="text-sm text-gray-500"
//                       id="villaApartmentName-label"
//                     >
//                       Villa/Apartment
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="villaApartmentName-label"
//                     >
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="floorName-label">
//                       Floor
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="floorName-label"
//                     >
//                       {asset.floorName}
//                     </p>
//                   </div>
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="roomName-label">
//                       Room
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="roomName-label"
//                     >
//                       {asset.roomName}
//                     </p>
//                   </div>
...
//                 />
//                 <div>
//                   <p className="text-sm text-gray-500" id="serviceName-label">
//                     Service
//                   </p>
//                   <p
//                     className="font-medium"
//                     aria-describedby="serviceName-label"
//                   >
//                     {asset.serviceName}
//                   </p>
//                 </div>
...
//                   <p
//                     className="font-medium"
//                     aria-describedby="subServiceName-label"
//                   >
...
//                   <p
//                     className="text-sm text-gray-500"
//                     id="serviceScopeNames-label"
//                   >
//                     Contract-Defined Service Scopes
//                   </p>
//                   <p
//                     className="font-medium"
//                     aria-describedby="serviceScopeNames-label"
//                   >
//                     {asset.serviceScopeNames &&
//                     asset.serviceScopeNames.length > 0
//                       ? asset.serviceScopeNames.join(", ")
...
//                     <p
//                       className="font-medium"
//                       aria-describedby="purchaseDate-label"
//                     >
//                       {asset.purchaseDate || "-"}
//                     </p>
//                   </div>
...
//                     <p
//                       className="text-sm text-gray-500"
//                       id="installationDate-label"
//                     >
//                       Installation Date
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="installationDate-label"
//                     >
//                       {asset.installationDate || "-"}
//                     </p>
//                   </div>
...
//                     <p
//                       className="text-sm text-gray-500"
//                       id="lastAuditDate-label"
//                     >
//                       Last Audit Date
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="lastAuditDate-label"
//                     >
//                       {asset.lastAuditDate || "-"}
//                     </p>
//                   </div>
...
//                     <p
//                       className="text-sm text-gray-500"
//                       id="createdByUsername-label"
//                     >
//                       Created By
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="createdByUsername-label"
//                     >
//                       {asset.createdByUsername || "-"}
//                     </p>
//                   </div>
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="createdAt-label">
//                       Created At
//                     </p>
//                     <p
//                       className="font-medium"
//                       aria-describedby="createdAt-label"
//                     >
//                       {asset.createdAt
//                         ? new Date(asset.createdAt).toLocaleString()
//                         : "-"}
...
//                   />
//                   <div>
//                     <p className="text-sm text-gray-500" id="companyName-label">
//                       Company
//                     </p>
//                     <p
//                       className="font-medium"
...
//                     <p
//                       className="font-medium"
//                       aria-describedby="contractName-label"
//                     >
//                       {asset.contractName}
//                     </p>
//                   </div>
...
//     try {
//       const response = await assetService.getAssetPdfReportData({
//         contractId: asset.contractId,
//         assetIds: [asset.assetId],
//         fields: selectedFields,
//       });

//       // Generate and download PDF/Word document
//       await downloadReport(response.data, format);
...
//     // For now, we'll create a simple HTML report and convert it
//     const reportContent = generateReportHTML(data);

//     if (format === "pdf") {
//       // Use jsPDF or similar library to convert HTML to PDF
//       const element = document.createElement("div");
//       element.innerHTML = reportContent;
//       element.style.display = "none";
//       document.body.appendChild(element);

//       // Here you would use html2pdf or similar library
//       // For demo purposes, we'll create a blob and download
//       const blob = new Blob([reportContent], { type: "text/html" });
//       const url = URL.createObjectURL(blob);
//       const link = document.createElement("a");
//       link.href = url;
//       link.download = `asset-report-${asset.assetTag}.html`;
//       link.click();
...
//             .field { padding: 10px; background: #f8f9fa; border-left: 4px solid #007bff; }
//             .field-label { font-weight: bold; color: #495057; margin-bottom: 5px; }
//             .field-value { color: #212529; }
//             .images { display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; }
//             .image { text-align: center; }
//             .image img { max-width: 100%; height: 150px; object-fit: cover; border: 1px solid #ddd; }
...
//   const generateFieldSections = (fields) => {
//     const categories = {
//       Basic: [],
//       Financial: [],
//       Organization: [],
...
//                   <div class="field-value">${formatFieldValue(
//                     field.key,
//                     field.value
//                   )}</div>
//                 </div>
