...
//         selectedServices.some((sel) => parseInt(sel.value, 10) === ss.serviceId)
//     )
//     .map((ss) => ({
//       value: ss.subServiceId.toString(),
//       label: ss.subServiceName,
...
//   const serviceScopeOptions = serviceScopes
//     .filter(
//       (sc) =>
//         selectedSubServices.length === 0 ||
//         selectedSubServices.some(
//           (sel) => parseInt(sel.value, 10) === sc.subServiceId
//         )
//     )
//     .map((sc) => ({
//       value: sc.scopeId.toString(),
...
//     const currentSubServiceIds = subServices
//       .filter(
//         (ss) =>
//           !isFiltered ||
//           selectedServices.some(
//             (sel) => parseInt(sel.value, 10) === ss.serviceId
//           )
//       )
//       .map((ss) => ss.subServiceId.toString());
//     setSelectedSubServices((prev) =>
//       prev.filter((p) => currentSubServiceIds.includes(p.value))
//     );
//   }, [selectedServices, subServices]);

//   useEffect(() => {
//     const isFiltered = selectedSubServices.length > 0;
//     const currentScopeIds = serviceScopes
//       .filter(
//         (sc) =>
//           !isFiltered ||
//           selectedSubServices.some(
...
//           )
//       )
//       .map((sc) => sc.scopeId.toString());
//     setSelectedServiceScopes((prev) =>
//       prev.filter((p) => currentScopeIds.includes(p.value))
//     );
//   }, [selectedSubServices, serviceScopes]);
